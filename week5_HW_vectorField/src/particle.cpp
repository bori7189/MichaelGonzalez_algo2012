...
//--------------------------------
void particle::checkLoc(){
    cout << "CheckLoc" << endl;
    if(pos.x <= -30 || pos.x >= ofGetWidth()+30 || pos.y <= -30 || pos.y >= ofGetHeight()+30){
        //pos.set(ofRandom(0, ofGetWidth()), ofRandom(ofGetHeight()-ofGetHeight()*0.75f, ofGetHeight()*0.75f));
